...
x_image = tf.reshape(xs, [-1, 28, 28, 1])#[InputAllPic,w,h,1] 
...
## conv2 layer ##
W_conv2 = weight_variable([5,5, 32, 48]) # patch 5x5, in size 32, out size 48
b_conv2 = bias_variable([48])
h_conv2 = tf.nn.relu(conv2d(h_pool1, W_conv2) + b_conv2) # output size 14x14x48
h_pool2 = max_pool_2x2(h_conv2)                          # output size 7x7x48

## conv3 layer ##
W_conv3 = weight_variable([5,5, 48, 64]) 
b_conv3 = bias_variable([64])
h_conv3 = tf.nn.relu(conv2d(h_pool2, W_conv3) + b_conv3) # output size 7x7x64
